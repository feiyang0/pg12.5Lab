					 ...
					 HashPath *best_path) 
{
     ...
     */
    hash_inner_plan = make_hash(inner_plan, inner_hashkeys, skewTable,
                                skewColumn, skewInherit);

    hash_outer_plan = make_hash(outer_plan, outer_hashkeys, skewTable,
                                skewColumn, skewInherit);
     ...
     */
    copy_plan_costsize(&hash_inner_plan->plan, inner_plan);
    hash_inner_plan->plan.startup_cost = hash_inner_plan->plan.total_cost;

    copy_plan_costsize(&hash_outer_plan->plan, outer_plan);
    hash_outer_plan->plan.startup_cost = hash_outer_plan->plan.total_cost;
    ...
    //     hash_inner_plan->plan.parallel_aware = true;
    //     hash_inner_plan->rows_total = best_path->inner_rows_total;

    //     hash_outer_plan->plan.parallel_aware = true;
    //     hash_outer_plan->rows_total = best_path->outer_rows_total;
    // }
